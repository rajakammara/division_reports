            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{route('create_issue')}}" method="POST">
                  ...
                  <div class="mb-3 mt-3">
                    <label for="app_number" class="form-label">Pending Reason:</label>
                    <div class="d-flex justify-content-between">
                      
                    <div class="form-check m-1">
                      <input class="form-check-input" type="radio" name="pending_reason" id="flexRadioDefault2" checked>
                    ...
                    <div class="d-flex justify-content-between">
                      <div class="form-check m-1">
                        <input class="form-check-input" type="radio" name="pending_reason" id="flexRadioDefault1">
                        <label class="form-check-label" for="flexRadioDefault1">
                          Pending in Other Mandal
                        </label>
                     </div>
                     <div class="form-check m-1">
                      <input class="form-check-input" type="radio" name="pending_reason" id="flexRadioDefault2" checked>
                      <label class="form-check-label" for="flexRadioDefault2">
                        Pending in Other District
                      </label>
                    </div>
                    </div>
